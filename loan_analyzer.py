...
print(f"Total number of loans is: {number_of_loans}\n")

# What is the total of all loans?
# Use the `sum` function to calculate the total of all loans in the list.
# Print the total value of the loans

""" @NOTE: We will use dollar ($) as currency sign in the solution. """

sum_of_loans = sum(loan_costs)
print(f"Sum total of the loan value is: ${sum_of_loans}\n")
...
print(f"Average loan price is: ${average_loan_price:.2f}\n")
...
print(f"Remaining months of the loan is: {remaining_months}\n")
...
print(f"Fair value of the loan ${loan_price} with a discount rate of {annual_discount_rate:.2f} is: ${present_value:.2f}\n")
...
def calculate_present_value(future_value, remaining_months, annual_discount_rate):
    """
    Calculates the present value or fair value of a loan price.
    A standard formula of Present Value is used to calculate the fair value.
    Pass the argument values of future_value, remaining_months, and annual_discount_rate respectively.
    
    The function returns the Present Value using a formula:
    present_value = future_value / (1 + annual_discount_rate / 12) ** remaining_months
    """
    present_value = future_value / (1 + annual_discount_rate / 12) ** remaining_months
...
# Make a function call to get the present value
...
for loan in inexpensive_loans:
    print(f"This is the inexpensive loan in the list: {loan}\n")
...
with open(output_path, 'w', newline='') as csvfile:
    ...
    # CSV file write operation done
    print(f"The results CSV file '{csvfile.name}' is now saved at: '{Path.cwd()}'.")